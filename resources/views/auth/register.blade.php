...
@section('content')
    ...
    <head>
        ...
        <!---- Website Information ---->
        <title>Gtcomnet Rider Dashboard </title>
                ...
                <div class="row justify-content-center h-100 align-items-center">
                    <div class="col-xl-8 col-md-8">
                        <div class="mini-logo text-center my-4"><a href="index.html"><img src="images/logo.png"
                                    alt=""></a>
                            <h4 class="card-title mt-5">Sign up to Gtcomnet Rider</h4>
                        </div>
                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="row">
                                        <div class="col-12 mb-3"><label class="form-label">Full Name</label><input
                                                ...
                                                placeholder="enter your fullname" value="{{ old('name') }}" required
                                                autocomplete="name">
                                            @error('name')
                                        ...
                                        <div class="col-12 mb-3"><label class="form-label">Confirm Password</label><input
                                                name="password_confirmation" type="text" class="form-control"
                                    ...
                                    <div class="mt-3 d-grid gap-2"><button type="submit"
                                            class="btn btn-primary mr-2">Sign
                                            Up</button></div>
                                </form>
                                <div class="text-center">
                                    <p class="mt-3 mb-0"><a class="text-primary" href="{{ route('login') }}">Sign
                                            in</a>to
                                        your
                                        account</p>
                                </div>
